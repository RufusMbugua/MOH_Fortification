...
class E_IntFortifiedA1 {
	...
	/*
	 *   @Id
	 * @Column(name="receiptNumber", type="int", length=11, nullable=false)
	 * */
	private $receiptNumber;

	/*
	 * @Column(name="productType", type="varchar", length=10, nullable=true)
	 * */
	private $productType;
	...
	/*
	 * @Column(name="inspectedBy", type="varchar", length=45, nullable=true)
	 * */
	private $inspectedBy;

	/*
	 * @Column(name="purchaseOrderNumber", type="int", length=11, nullable=true)
	 * */
	...
	private $dates;
	/*
	 * @Column(name="quantity", type="double", length=45, nullable=true)
	 * */
	private $quantity;

	/*
	 * @Column(name="integrityObservation", type="varchar", length=45, nullable=false)
	 * */
	private $integrityObservation;

	/*
	 * @Column(name="lotNumber", type="int", length=11 nullable=true)
	 * */
	private $lotNumber;

	/*
	 * @Column(name="lotObservation", type="varchar", length=45, nullable=false)
	 * */
	private $lotObservation;

	/*
	 * @Column(name="productionDate", type="date", nullable=true)
	 * */
	private $productionDate;

	/*
	 * @Column(name="productObservation", type="varchar", length=45, nullable=false)
	 * */
	...
	/*
	 * @Column(name="expirationObservation", type="varchar", length=45, nullable=false)
	 * */
	private $expirationObservation;

	/*
	 * @Column(name="contentClaimLabel", type="varchar", length=45, nullable=true)
	 * */
	private $contentClaimLabel;

	/*
	 * @Column(name="contentObservation", type="varchar", length=45, nullable=false)
	 * */
	private $contentObservation;

	/*
	 * @Column(name="certificateOfAnalysis", type="varchar", length=45, nullable=true)
	 * */
	private $certificateOfAnalysis;

	/*
	 * @Column(name="certificateObservation", type="varchar", length=45, nullable=false)
	 * */
	private $certificateObservation;

	/*
	 * @Column(name="other", type="varchar", length=45, nullable=true)
	 * */
	private $other;

	/*
	 * @Column(name="otherObservation", type="varchar", length=45, nullable=true)
	 * */
	private $otherObseravtion;

	/*
	 * @Column(name="accepted", type="tinyint", length=1, nullable=true)
	 * */
	private $accepted;

	/*
	 * @Column(name="reasonForRejection", type="varchar", length=45, nullable=true)
	 * */
	private $reasonsForRejection;

	/*
	 * @Column(name="receivedBy", type="varchar", length=45, nullable=false)
	 * */
	private $receivedBy;
	...
	public function setLotObservation($productionDate) { $this -> productionDate = $productionDate;
	}
	...
	public function getOtherObseravtion() {
		return $this -> otherObseravtion;
	}

	public function setOtherObseravtion($otherObseravtion) { $this -> otherObseravtion = $otherObseravtion;
	}
